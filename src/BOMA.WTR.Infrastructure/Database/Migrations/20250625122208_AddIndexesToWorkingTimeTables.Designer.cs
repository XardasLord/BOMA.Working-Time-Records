...
namespace BOMA.WTR.Infrastructure.Database.Migrations
{
    ...
    [Migration("20250625122208_AddIndexesToWorkingTimeTables")]
    partial class AddIndexesToWorkingTimeTables
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BOMA.WTR.Domain.AggregateModels.Setting.Setting", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Key = "MinimumWage",
                            LastModified = new DateTimeOffset(new DateTime(2025, 6, 25, 12, 22, 7, 683, DateTimeKind.Unspecified).AddTicks(873), new TimeSpan(0, 0, 0, 0, 0)),
                            Type = "int",
                            Value = "4666"
                        });
                });
                    ...
                    b.OwnsOne("BOMA.WTR.Domain.AggregateModels.Entities.EmployeeSalaryAggregatedHistory", "SalaryInformation", b1 =>
                        {
                            ...
                            b1.Property<decimal>("MinSalaryCompensationAmount")
                                .HasColumnType("decimal(10,2)");

                            b1.Property<decimal>("MinSalaryCompensationFactor")
