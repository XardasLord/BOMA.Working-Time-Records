...
namespace BOMA.WTR.Infrastructure.Database.Migrations
{
    ...
    [Migration("20220707143719_AddSalaryColumns")]
            ...
            modelBuilder.Entity("BOMA.WTR.Domain.AggregateModels.Employee", b =>
                {
                    ...
                    b.OwnsOne("BOMA.WTR.Domain.AggregateModels.ValueObjects.PercentageBonus", "PercentageSalaryBonus", b1 =>
                        {
                            b1.Property<int>("EmployeeId")
                                .HasColumnType("int");
                    ...
                    b.Navigation("PercentageSalaryBonus")
                        .IsRequired();
